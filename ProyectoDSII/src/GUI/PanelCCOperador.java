...
public class PanelCCOperador extends JPanel
{
	...
	public PanelCCOperador() {
		...
		opLlamada = "Operadores Locales Mas Usados por Llamadas";
		opSMS = "Operadores Locales Mas Usados por Sms";
		opInternet = "Operadores Locales Mas Usados por Datos";
		
		JLabel lblSeleccioneElTipo = new JLabel("Seleccione el tipo de consumo del operador que desea ver");
